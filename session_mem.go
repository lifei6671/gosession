...
var memoryProvider = &SessionMemoryProvider{lruList: list.New(), container: make(map[string]*list.Element, 10), maxlifetime: 1800, rwMutex: sync.RWMutex{}}
...
func (store *SessionMemoryStore) Get(key string) (interface{}, error) {
	...
	return nil, ErrSessionValueNotExist
}
